...
<html>
    <head>
        ...
        <title>SIDAKANTAR - Set Cost</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Set Harga biaya jasa</h3>
                                            ...
                                            <form role="form">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Sidak-Ride</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Sidak-Car</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Sidak-Food</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Sidak-Mart</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1"> Sidak-Send</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Sidak-Massage</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">M-Clean</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Sidak-Service</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="xxxx">
                                                    </div><br>
                                                </div>
                                                <!-- /.box-body -->
