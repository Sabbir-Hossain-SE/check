                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    <td><b>Berkas Lamaran</b></td>
                                                    <td><p class="text-left">: <a href="#">Lihat Berkas</a></p></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Berkas CV</b></td>
                                                    <td><p class="text-left">: <a href="#">Lihat Berkas</a></p></td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2"></div>
                                        <div class="col-md-4">
                                            <a class="btn btn-primary" href="#" role="button" onclick="return confirm('Apakah anda yakin melakukan validasi kepada pendaftaran driver tersebut ?')">Validasi Pendaftaran Driver</a>
                                        </div>
                        ...
                        <div class="col-xs-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <!--style="width: 100%; height: 100%; border: 3px; border-color: white;"-->
                                    <img src="dist/img/KTP.JPG" class="img-responsive img-thumbnail center-block" alt="Cinque Terre">
                        ...
                        <div class="col-xs-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <!--style="width: 100%; height: 100%; border: 3px; border-color: white;"-->
                                    <img src="dist/img/SIM.JPG" class="img-responsive img-thumbnail center-block" alt="Cinque Terre">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <!--style="width: 100%; height: 100%; border: 3px; border-color: white;"-->
                                    <img src="dist/img/STNK.JPG" class="img-responsive img-thumbnail center-block" alt="Cinque Terre">
