...
<html>
    <head>
        ...
        <title>SIDAKANTAR - Help Center</title>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List Keluhan Pelanggan</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="mailto:ArdeniBayu@gmail.com" target="_top">dasunna@gmail.com</a></td>
                                                <td>2016-10-12 06:45:00</td>
                                                <td>Nganu mas, ini tadi saya top up tapi kok sampai sekarang belum ada tanggapan dari pihak mang-jek ya ? tolong pak di cek verifikasi top up saya..</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
<!--                                            <tr>
