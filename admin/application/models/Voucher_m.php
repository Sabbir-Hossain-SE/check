...
class Voucher_m extends CI_Model {
    ...
    function getAllVoucher() {
        $query = $this->db->query("
                ...
                FROM `voucher` a , tipe_voucher b , fitur_mangjek c
    ...
    function insertVoucher($nama, $tipe, $fitur, $nilai, $kuota, $keterangan) {
        $query = $this->db->query("
            ...
            function insertVoucher_addpromo($nama, $tipe, $fitur, $nilai, $kuota, $keterangan,$datePickerStart) {
        $query = $this->db->query("
                INSERT INTO `voucher` (`id`, `voucher`, `tipe_voucher`, `untuk_fitur`, `tanggal_expired`, `nilai`, `keterangan`, `count_to_use`, `is_valid`) 
                VALUES (NULL, '$nama', '$tipe', '$fitur','$datePickerStart' , '$nilai', '$keterangan', '$kuota', 'yes')
            ");
    ...
    function getFitur() {
        $query = $this->db->select('id, fitur')->from('fitur_mangjek')->get();
        return $query->result();
    }
