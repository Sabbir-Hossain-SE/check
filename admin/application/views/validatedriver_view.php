                                ...
                                <div class="box-body">
                                  ...
                                  <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                    	<a href="<?php echo base_url() ?>index.php/Validatedriver/detilPelamarDriver/<?php echo "$d->nomor"; ?>/<?php echo "$tittle";?>"><button type="button" class="btn btn-default btn-sm">View Details</button></a>
                                                    	<a href="<?php echo base_url() ?>index.php/Validatedriver/detailsDriver/<?php echo "$d->nomor"; ?>"><button type="button" class="btn btn-default btn-sm">Edit Details</button></a>
                                                    </td>
                                                    <td>
