...
<meta content="template gotaxi" name="keywords">
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>dist/css/jquery-ui.css">
                            ...
                            <div class="content-box">
                                ...
                                <div class="box-body">
                                    ...
                                    <form role="form" action="<?php echo base_url(); ?>index.php/Voucher/insertDiskonPersen" method="post">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Expir Date</label>
                                                <input type="test" name="datePickerStart" class="datePickerStart form-control">
                                            </div>
                                        </div>
